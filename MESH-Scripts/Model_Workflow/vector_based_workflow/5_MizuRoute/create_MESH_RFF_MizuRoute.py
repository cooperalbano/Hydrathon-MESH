...
input_topology     = '../workflow_data/domain_SaintMaryMilk/topology/network_topology_SaintMaryMilk.nc'
domain_name        = 'SaintMaryMilk' 
outdir             = '../workflow_data/domain_SaintMaryMilk/drainagedatabase/'
start_sim          = '1/2/2010'
end_sim            = '31/12/2018'
input_rff          = '../6_model_runs/SaintMaryMilk_MizuRoute/'
